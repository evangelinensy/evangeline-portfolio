...
import { TimezoneGreeting } from "@/components/ui/timezone-greeting";
import {
...
export default function AboutPage() {
  return (
    <CursorProvider>
      <div className="min-h-screen bg-white py-16" style={{ isolation: 'isolate', position: 'relative', zIndex: 0 }}>
